...
export async function fetchTransactions() {
  const data = await fetchWithRetry<any>(`${API_BASE}/transactions`);
...
export function createSSEConnection(
  ...
  const eventTypes = ['negotiation_start', 'agent_speak', 'validation_complete', 'task_complete', 'agent_complete', 'settlement_complete', 'agent_start', 'task_received', 'orchestrator_complete', 'negotiation_complete'];
